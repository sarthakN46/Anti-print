...
function readMultilineEnv(): Promise<string> {
  console.log('\n--- Paste your environment variables below ---');
...
async function resetDatabase() {
  ...
  console.log('2. Custom / Production (paste your Render .env variables)\n');
  ...
  try {
    ...
    await User.createCollection(); await User.syncIndexes(); console.log('   ✓ Users collection created');
    await Shop.createCollection(); await Shop.syncIndexes(); console.log('   ✓ Shops collection created');
    await Order.createCollection(); await Order.syncIndexes(); console.log('   ✓ Orders collection created');
